...
def processImage(filepath):
    ...
    #plt.show()
    object_class = label[1]
    accuracy = str(label[2])
    accuracy = accuracy[0]+accuracy[2:6]
    # print(accuracy)
    return accuracy, object_class, '0'     #TODO change the error
    
# processImage('ImageProcessing\cat.jpeg')